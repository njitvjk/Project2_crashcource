...
def test_006_get_first_result(clear_history):
...
def test_009_division(clear_history):
    """Case9 :Division"""
    # pylint: disable=unused-argument,redefined-outer-name
    assert Calculator.divide_numbers(2, 2) == 1
def test_010_get_history(clear_history):
...
def test_011_division_by_zero(clear_history):
